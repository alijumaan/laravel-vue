        ...
        <div class="col-8">
            <form @submit.prevent="submit_form">
                ...
                <div class="mt-3">
                    ...
                    <textarea class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm p-1"
                ...
                <div class="mt-3">
                    ...
                    <select v-model="fields.category_id" class="relative px-3 py-2 bg-white text-gray-500 rounded focus:outline-none"
                            id="category_id">
                ...
                <div class="mt-3">
                    <input class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-gray disabled:opacity-25 transition ease-in-out duration-150"
                           type="submit" :value="form_submitting ? 'Saving post...' : 'Save post'" :disabled="form_submitting" />
                </div>
            </form>
        </div>
    </div>
